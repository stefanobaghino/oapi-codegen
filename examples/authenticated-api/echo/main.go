...
import (
	...
	"github.com/stefanobaghino/oapi-codegen/v2/examples/authenticated-api/echo/api"
	"github.com/stefanobaghino/oapi-codegen/v2/examples/authenticated-api/echo/server"
